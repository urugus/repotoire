...
final libraryRepositoryProvider = Provider<LibraryRepository>((ref) {
  return LibraryRepository(
    ...
    operationQueue: ref.watch(localOperationQueueProvider),
  );
});

final localOperationQueueProvider = Provider<LocalOperationQueue>((ref) {
  return LocalOperationQueue(database: ref.watch(appDatabaseProvider));
});
